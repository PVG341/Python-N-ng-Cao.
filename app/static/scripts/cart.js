                            ...
                            cartContainer.innerHTML = `
                                ...
                                data.cart_items.forEach(item => {
                                    ...
                                    const formattedPrice = new Intl.NumberFormat('vi-VN', {
                                        style: 'decimal', // Chỉ định dạng số, không thêm ký hiệu tiền tệ
                                        minimumFractionDigits: 0
                                    }).format(item.prod_price);
                                    ...
                                    cartContainer.innerHTML += `
                                        <div class="cart-items row">
                                            <div class="cart-row cart-product-data">
                                                ...
                                                <span class="cart-price cart-column money" data-price="${item.prod_price}">${formattedPrice} VNĐ</span>
